...
class RetractTowerController(QObject):
    ...
    def settingsAreCompatible(self)->str:
        ...
        if supportEnabled:
            ...
            return [False, f'A Retract Tower cannot be generated correctly with "{setting_label}" enabled.\nFix this setting and try again.']
        ...
        retraction_enabled = globalContainerStack.getProperty('retraction_enable', 'value')
        Logger.log('d', f'retraction_enabled = {retraction_enabled}')
        if not retraction_enabled:
            setting_label = globalContainerStack.getProperty('retraction_enable', 'label')
            return [False, f'A Retract Tower cannot be generated correctly with "{setting_label}" disabled.\nFix this setting and try again.']
